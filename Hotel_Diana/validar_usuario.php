				...
				<form accept-charset="UTF-8" id="formahotel" class="form" name="formahotel" method="post" action="http://www.e-tsw.com.mx/Hoteles/Tarifas">
					...
					<div class="etWrow">
						<div class="etWheader">
                                                    ...
                                                    <label><font color="#7438ee" face="Monotype corsiva" size="4" ><center>Cuartos:</center></font></label>
							...
							<option value="5">5</option>
                                                   ...
                                                   <label><font color="#7438ee" face="Monotype corsiva" size="4" ><center>Adultos:</center>
                                                            </font></label>
							...
							<option value="5">5</option>
                                                     ...
                                                     <label><font color="#7438ee" face="Monotype corsiva" size="4" ><center>Niños:</center>
